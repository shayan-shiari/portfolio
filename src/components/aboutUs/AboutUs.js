        ...
        <MainBook open={setIsOpen}>
          <HTMLFlipBook width={500} height={600}>
            <BookPage aboutImage={gif} number={1}>
              ...
              <p className="text-[16px] text-gray-600">Our skills:</p>
            ...
            <BookPage number={2}>
              <div className="w-[70%] flex flex-col gap-y-1">
                ...
                <div>
                  ...
                  <div class="bg-gray-600 flex w-[75%] items-center justify-center rounded-2xl text-xs font-semibold text-white">
                    75%
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div class="bg-gray-600 flex w-[65%] items-center justify-center rounded-2xl text-xs font-semibold text-white">
                    65%
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div class="bg-gray-600 flex w-[70%] items-center justify-center rounded-2xl text-xs font-semibold text-white">
                    70%
                  </div>
                </div>
              </div>
